...
function M.setup(cfg)
  ...
  if spell_cfg.live then
    ...
    -- Rescan on edits.
    autocmd.create({ "TextChanged", "InsertLeave" }, live_change, {
      group = group,
    ...
    if spell_cfg.live_scope == "visible" then
      autocmd.create("WinScrolled", live_change, {
        group = group,
